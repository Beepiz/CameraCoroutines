...
object Libs {
    ...
    object Beepiz {
        val bleGattCoroutines = BleGattCoroutines
        object BleGattCoroutines {
            private const val version = "0.3.0"
            private const val prefix = "com.beepiz.blegattcoroutines:blegattcoroutines"
            const val core = "$prefix-core:$version"
            const val genericaccess = "$prefix-genericaccess:$version"
        }
    }
}
