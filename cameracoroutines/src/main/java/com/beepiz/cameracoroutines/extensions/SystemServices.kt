...
inline val wifiManager: WifiManager @SuppressLint("WifiManagerLeak") get() = getSystemService(WIFI_SERVICE)
...
inline val textServicesManager: TextServicesManager get() = getSystemService(TEXT_SERVICES_MANAGER_SERVICE)
...
inline val bluetoothManager: BluetoothManager @RequiresApi(18) get() = getSystemService(BLUETOOTH_SERVICE)
...
inline val consumerIrManager: ConsumerIrManager @RequiresApi(19) get() = getSystemService(CONSUMER_IR_SERVICE)
inline val captioningManager: CaptioningManager @RequiresApi(19) get() = getSystemService(CAPTIONING_SERVICE)

inline val appWidgetManager: AppWidgetManager @RequiresApi(21) get() = getSystemService(APPWIDGET_SERVICE)
inline val mediaSessionManager: MediaSessionManager @RequiresApi(21) get() = getSystemService(MEDIA_SESSION_SERVICE)
inline val telecomManager: TelecomManager @RequiresApi(21) get() = getSystemService(TELECOM_SERVICE)
inline val launcherApps: LauncherApps @RequiresApi(21) get() = getSystemService(LAUNCHER_APPS_SERVICE)
inline val restrictionsManager: RestrictionsManager @RequiresApi(21) get() = getSystemService(RESTRICTIONS_SERVICE)
...
inline val jobScheduler: JobScheduler @RequiresApi(21) get() = getSystemService(JOB_SCHEDULER_SERVICE)
inline val mediaProjectionManager: MediaProjectionManager @RequiresApi(21) get() = getSystemService(MEDIA_PROJECTION_SERVICE)
...
inline val hardwarePropertiesManager: HardwarePropertiesManager @RequiresApi(24) get() = getSystemService(HARDWARE_PROPERTIES_SERVICE)
inline val systemHealthManager: SystemHealthManager @RequiresApi(24) get() = getSystemService(SYSTEM_HEALTH_SERVICE)

inline val shortcutManager: ShortcutManager @RequiresApi(25) get() = getSystemService(SHORTCUT_SERVICE)

inline val companionDeviceManager: CompanionDeviceManager @RequiresApi(26) get() = getSystemService(COMPANION_DEVICE_SERVICE)
